...
@property (nonatomic,strong) NSMutableArray *localMap;//本地映射
@property (nonatomic,strong) NSMutableArray *netMap;//网络映射
@property (nonatomic,strong) NSMutableArray *tempMap;//代码临时设置映射
